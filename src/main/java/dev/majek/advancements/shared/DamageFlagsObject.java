...
public class DamageFlagsObject extends SharedObject {
	 ...
	 */
	public @Nullable Boolean explosion() {
	 ...
	 */
	public @Nullable Boolean projectile() {
	 ...
	 */
	public @Nullable Boolean lightning() {
	 ...
	 */
	public @Nullable EntityObject directEntity() {
	 ...
	 */
	public @NotNull DamageFlagsObject bypassesArmor(final @Nullable Boolean bypassesArmor) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject bypassesInvulnerability(final @Nullable Boolean bypassesInvulnerability) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject bypassesMagic(final @Nullable Boolean bypassesMagic) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject explosion(final @Nullable Boolean explosion) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject fire(final @Nullable Boolean fire) {
		this.fire = fire;
		return this;
	}
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject magic(final @Nullable Boolean magic) {
		this.magic = magic;
		return this;
	}
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject projectile(final @Nullable Boolean projectile) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject lightning(final @Nullable Boolean lightning) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject sourceEntity(final @Nullable EntityObject sourceEntity) {
	 ...
	 * @return the current damage flags object for chaining
	 */
	public @NotNull DamageFlagsObject directEntity(final @Nullable EntityObject directEntity) {
		this.directEntity = directEntity;
		return this;
	}

	/**
	 * @return the Json representation of the damage flags object
	 */
	@Override
